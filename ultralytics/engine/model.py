    ...
    def train(
        ...
        **kwargs: Any,
        ...
        if not args.get("resume"):  # manually set model only if not resuming
            ...
            # here we replace with lora if needed
            if (config.Global_R_LoRA > 0):
                replace_conv_to_LoRa(self.model.model, r=config.Global_R_LoRA)
                loralib.mark_only_lora_as_trainable(self.model.model)
